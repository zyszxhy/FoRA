...
class C2f_lora(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, r=0, lora_alpha=1, lora_dropout=0., g=1, e=0.5):
        ...
        self.cv1 = Conv_lora(c1, 2 * self.c, 1, 1, r, lora_alpha, lora_dropout)
        self.cv2 = Conv_lora((2 + n) * self.c, c2, 1, 1, r, lora_alpha, lora_dropout)  # optional act=FReLU(c2)
...
class Bottleneck_lora(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5, r=0, lora_alpha=1, lora_dropout=0.):
        ...
        self.cv1 = Conv_lora(c1, c_, k[0], 1, r, lora_alpha, lora_dropout)
        self.cv2 = Conv_lora(c_, c2, k[1], 1, r, lora_alpha, lora_dropout, g=g)
...
class SPPF_lora(nn.Module):
    ...
    def __init__(self, c1, c2, k=5, r=0, lora_alpha=1, lora_dropout=0.):
        ...
        self.cv1 = Conv_lora(c1, c_, 1, 1, r, lora_alpha, lora_dropout)
        self.cv2 = Conv_lora(c_ * 4, c2, 1, 1, r, lora_alpha, lora_dropout)
